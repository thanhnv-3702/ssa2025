...
class RefreshLocalizationsDelegate extends LocalizationsDelegate<RefreshLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) {
    return ['en', 'zh', 'fr', 'ru', 'uk', 'ja', 'it', 'de', 'ko', 'pt', 'sv', 'nl', 'es', 'hu'].contains(locale.languageCode);
  }
...
class HuRefreshString implements RefreshString {
  @override
  String? canLoadingText = "Engedje el a több betöltéséhez";

  @override
  String? canRefreshText = "Engedje el a frissítéshez";

  @override
  String? canTwoLevelText = "Engedje el a második szintre lépéshez";

  @override
  String? idleLoadingText = "Húzza felfelé a több betöltéséhez";

  @override
  String? idleRefreshText = "Húzza le a frissítéshez";

  @override
  String? loadFailedText = "Betöltés sikertelen";
  ...
  @override
  String? refreshFailedText = "Frissítés sikertelen";
